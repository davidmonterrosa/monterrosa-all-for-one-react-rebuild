  ...
  return (
    <main className="bg-[#303030] flex justify-center">
      <section className="bg-black shadow-[0_0_20px_#00FFFF32] rounded-2xl flex justify-center my-8 mx-4 p-6">
        <section className="bg-[#E24662] lg:bg-[#111828] rounded-2xl px-3 pt-10 pb-12">
          <div className="flex justify-center">
            <div className="lg:bg-[url(../src/assets/icons/HelloWorld.png)] lg:bg-cover lg:bg-center lg:rounded-2xl lg:aspect-[12/7] lg:w-[480px] lg:h-[280px]helloworld-heading-area bg-cover bg-center rounded-xl w-80 h-56">
          ...
          <section className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center gap-x-20 lg:mt-20 lg:mx-12">
            <div className="flex flex-col items-center">
              ...
              <input onChange={(event) => setNameInput(event.target.value)} className="press-start-2p rounded-2xl border-[3px] border-solid border-black max-w-[275px] max-h-[50px] placeholder:text-white text-white bg-[#45569D]" type="text" placeholder="Name"
              />
            </div>
