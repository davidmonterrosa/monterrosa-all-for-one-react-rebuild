  ...
  return (
    <main className="bg-[#303030] flex justify-center">
      <section className="bg-black shadow-[0_0_20px_#00FFFF32] rounded-2xl flex justify-center my-8 mx-4 p-6">
        <section className="bg-[#3395AB] lg:bg-[#111828] rounded-2xl px-3 pt-10 pb-12">
          ...
          <section className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:gap-x-20 lg:items-center lg:mt-20 lg:mx-20 place-content-center">
            <div className="flex flex-col items-center">
              ...
              <input
                ...
                className="text-white placeholder:text-white  press-start-2p rounded-2xl border-[3px] border-black border-solid max-w-[275px] max-h-[50px] bg-[#E2397B]"
                type="text"
                placeholder="Number"
              />
            </div>
