  ...
  return (
    <main className="bg-[#303030] flex justify-center">
      <section className="bg-black shadow-[0_0_20px_#00FFFF32] rounded-2xl flex justify-center my-8 mx-4 p-6">
        <section className="bg-[#F9A159] lg:bg-[#111828] rounded-2xl px-3 pt-10 pb-12">
          <div className="grid grid-cols-1 lg:grid-rows-[auto] lg:grid-cols-[auto] place-items-center">
            ...
            <section className="lg:flex lg:justify-evenly items-center lg:gap-x-10 lg:row-start-2 lg:mt-8 lg:px-10">
                <input type="text" placeholder="First Number" onChange={(event) => setFirstNumberInput(event.target.value)} className="text-center text-white placeholder:text-white  press-start-2p rounded-2xl border-[3px] border-black border-solid max-w-[275px] max-h-[50px] bg-[#45569D]"/>
                <h1 className="text-white text-center text-6xl">+</h1>
                <input type="text" placeholder="Second Number" onChange={(event) => setSecondNumberInput(event.target.value)} className="text-center text-white placeholder:text-white  press-start-2p rounded-2xl border-[3px] border-black border-solid max-w-[275px] max-h-[50px] bg-[#3AB8CB]"/>
                <h1 className="text-white text-center text-6xl">=</h1>
