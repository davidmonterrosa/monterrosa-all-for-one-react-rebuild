  ...
  return (
    <main className="bg-[#303030] flex justify-center">
      <section className="bg-black shadow-[0_0_20px_#00FFFF32] rounded-2xl flex justify-center my-8 mx-4 p-6">
        <section className="bg-[#ED885C] lg:bg-[#111828] rounded-2xl px-3 pt-10 pb-12">
          ...
          <section className="grid grid-cols-1 gap-y-8 lg:grid-cols-4 lg:gap-x-8  lg:mt-20">
            <div className="flex flex-col items-center lg:mt-14">
              ...
              <input
                ...
                className="text-white placeholder:text-white  press-start-2p rounded-2xl border-3 border-black border-solid max-w-[275px] max-h-[50px] bg-[#A96AAD]"
              />
            </div>
            ...
            <div className="flex flex-col items-center lg:mt-14">
              ...
              <input
                ...
                className="text-white placeholder:text-white  press-start-2p rounded-2xl border-3 border-black border-solid max-w-[275px] max-h-[50px] bg-[#8B3972]"
              />
            </div>
