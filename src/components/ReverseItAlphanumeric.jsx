...
import { getReverseAlphanumeric } from "../services/services";
...
const ReverseItAlphanumeric = () => {
  ...
  const fetchResult = async () => {
    setResult(await getReverseAlphanumeric(stringInput));
  };
  return (
    <main className="bg-[#303030] flex justify-center">
      <section className="bg-black shadow-[0_0_20px_#00FFFF32] rounded-2xl flex justify-center my-8 mx-4 p-6">
        <section className="bg-[#DC4988] lg:bg-[#111828] rounded-2xl px-3 pt-10 pb-12">
          <div className="flex justify-center">
            <div className="lg:bg-[url(../src/assets/icons/ReverseItAlphanumeric.png)] lg:bg-cover lg:bg-center lg:rounded-2xl lg:aspect-[12/7] lg:w-[480px] lg:h-[280px] ">
              <h1 className="text-center text-white text-xl lg:text-4xl lg:flex lg:items-center lg:justify-center lg:px-15 lg:min-h-full lg:backdrop-brightness-[0.25] lg:rounded-2xl  mb-8">
                Reverse It <br /> Alphanumeric
              </h1>
            </div>
          </div>
          <section className="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:gap-x-20 lg:items-center lg:mt-20 lg:mx-20 place-content-center">
            <div className="flex flex-col items-center">
              ...
              <input
                ...
                className="text-white placeholder:text-white  press-start-2p rounded-2xl border-[3px] border-black border-solid max-w-[275px] max-h-[50px] bg-[#3CA2C4]"
                type="text"
                placeholder="String"
              />
            </div>
